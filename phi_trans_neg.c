...
n3      = diff_z1 / diff_tot;	    
    ...
    for(i=2;i<=a;i++){
      ...
      if(res_number[i] == aminoresnum) {
          ...
          atom_x[i] = atom_x[i] - atom_2_x;
          atom_y[i] = atom_y[i] - atom_2_y;
          atom_z[i] = atom_z[i] - atom_2_z;	  
    ...
    for(i=2;i<=a;i++){
      ...
      if(res_number[i] == aminoresnum) {
          ...
          atom_x2[i] = atom_x2[i] + atom_2_x;
          atom_y2[i] = atom_y2[i] + atom_2_y;
          atom_z2[i] = atom_z2[i] + atom_2_z;	  
